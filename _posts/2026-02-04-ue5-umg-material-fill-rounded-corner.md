...
![InvalidationBox 사용 시 — 스크롤하면 텍스처가 검은색으로 말려 올라간다](/assets/images/ue5-umg-material-fill-rounded-corner/Before.webp)
...
![Material 방식 적용 후 — 스크롤해도 정상 렌더링된다](/assets/images/ue5-umg-material-fill-rounded-corner/After.webp)
